...
@Component({
  selector: 'coffee-brand-carousel',
  templateUrl: './coffee-brand-carousel.component.html',
  styleUrls: ['./coffee-brand-carousel.component.less']
})

export class CoffeeBrandCarouselComponent implements OnInit {
  ...
  selectCoffee(coffeeBrand: CoffeeBrand) {
      this.msgs = [];
      this.msgs.push({severity: 'info', summary: 'Coffee Brand Selected', detail: 'Roast:' + coffeeBrand.favoriteRoast});
  }
